    ...
    <section data-hash="about-me" className="flex flex-col lg:p-16 p-4 items-center overflow-hidden">
      <div className="w-full grid lg:grid-cols-2 lg:gap-0 max-[440px]:gap-4 gap-24 grid-cols-1 items-center max-w-[84rem]">
        <div className="flex flex-col sm:gap-4 gap-2 text-[#a5967e] *:max-w-xl sm:text-lg h-fit">
          ...
          <p>I’ve built 50+ worlds—several officially VRChat-approved—including hits like <i>Isolated Night</i> and <i>Of Azure, Stars Shine</i>. Several reached #1 on the Popular tab, with eight surpassing 100k visits and 10k favorites. Collectively, my projects have drawn over 3 million visits and have been featured in VRChat promo materials, developer updates, and the Pico 4 launch.</p>
          <p>My collaborations span HashStudios LLC, Dubby.gg, VR events like VKET Winter 2024, and art galleries in Tokyo and London. I’ve also led a VRChat community of 4,000+, run a Creator Economy Store, and been honored with awards including Spookality (twice) and VRCA 2024/2025 nominations.</p>
        </div>
        <div 
